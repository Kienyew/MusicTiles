...
void drawGame()
{
	...
	for (int line = 0; line < LINE; ++line)
	{
		...
		DrawLineEx((Vector2) { LEFT_MARGIN + (line * LINE_WIDTH) + (line * MARGIN_BETWEEN_LINE), 0 },
			(Vector2) {
			LEFT_MARGIN + (line * LINE_WIDTH) + (line * MARGIN_BETWEEN_LINE), SCREEN_HEIGHT - TOUCH_BLOCK_MARGIN_BOTTOM
		},
			SIDE_LINE_WIDTH,
				SIDE_LINE_COLOR);
		...
		DrawLineEx((Vector2) { LEFT_MARGIN + LINE_WIDTH + (line * LINE_WIDTH) + (line * MARGIN_BETWEEN_LINE), 0 },
			(Vector2) {
			LEFT_MARGIN + LINE_WIDTH + (line * LINE_WIDTH) + (line * MARGIN_BETWEEN_LINE), SCREEN_HEIGHT - TOUCH_BLOCK_MARGIN_BOTTOM
		},
			SIDE_LINE_WIDTH,
				SIDE_LINE_COLOR);
	}
